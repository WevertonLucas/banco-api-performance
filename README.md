...
🔗 Repositório: [github.com/WevertonLucas/banco-api-performance](https://github.com/WevertonLucas/banco-api-performance)
...
```bash
git clone https://github.com/WevertonLucas/banco-api-performance.git
...
```bash
set "K6_WEB_DASHBOARD=true" && set "K6_WEB_DASHBOARD_EXPORT=html-report.html" && k6 run tests\login.test.js -e BASE_URL=http://localhost:3000
```
